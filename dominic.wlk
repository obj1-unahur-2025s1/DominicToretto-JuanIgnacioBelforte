...
object flecha {
  ...
  method enCondiciones() = cantidadLitrosCombustible > combustible.nivelMinimo() && color.esAptoParaCorrer()
  ...
  method velocidadMaxima() = cantidadLitrosCombustible + combustible.calculoAdicional(cantidadLitrosCombustible)
}
